...
$('.seatNO').on('click', function() {
	...
	if($('.seatNO').eq(idx).attr('title') == 'seatOK') {
		// 예약 취소
		if(confirm("좌석 " + $('.seatNO').eq(idx).val() + "번을 예약을 취소하시겠습니까?")) {
			// alert("좌석을 예약합니다.");
			$.ajax({
